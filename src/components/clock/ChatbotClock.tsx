...
import MinuteHand from "./clock-logo-minute-hand.svg";
import HourHand from "./clock-logo-hour-hand.svg";
import ClockBackground from "./clock-logo-background.svg";
...
const ChatbotClock = ({
  ...
  useEffect(() => {
    function initLocalClocks() {
      ...
      const clock = document.getElementById(`chatbot-clock-logo`);
...
// Disable SSR
export default dynamic(() => Promise.resolve(ChatbotClock), { ssr: false });
